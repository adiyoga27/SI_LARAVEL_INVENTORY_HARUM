                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="true">
                                <li>
                                    <a href="{{ route('category-product.index') }}" key="t-vertical">Kategori</a>

                                </li>

                                <li>
                                    <a href="{{ route('unit-product.index') }}" key="t-horizontal">Satuan</a>
                                ...
                                <li>
                                    <a href="{{ route('supplier.index') }}" key="t-horizontal">Supplier</a>
